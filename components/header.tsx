...
const Header = () => {
    return (
        <div>
            ...
            <div>
                <Image src={addicon} width="44px" height="44px" onClick={() => window.location.href = "https://www.wenjuan.com/s/UZBZJvEOdvM/#%E3%80%8A%E5%B0%8F%E6%B8%B8%E6%88%8F%E6%8E%A8%E8%8D%90%E3%80%8B"} />
            </div>
        </div>
    )
}
